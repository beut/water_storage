...
android {
    namespace = "pl.watershed.septictank"
    compileSdk = 34

    defaultConfig {
        applicationId = "pl.watershed.septictank"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // History chart (research.md -> "Biblioteka wykresow dla Jetpack Compose", 002-history-visual-redesign)
